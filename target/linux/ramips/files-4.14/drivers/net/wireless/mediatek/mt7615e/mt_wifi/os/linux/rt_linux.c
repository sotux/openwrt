...
ULONG DebugSubCategory[32] =
{
	DBG_SUBCAT_ALL,			/* bit_0, for DBG_CAT_INIT */
	DBG_SUBCAT_ALL,			/* bit_1, for DBG_CAT_HW */
	DBG_SUBCAT_ALL,			/* bit_2, for DBG_CAT_FW */
	DBG_SUBCAT_ALL,			/* bit_3, for DBG_CAT_HIF */
	DBG_SUBCAT_ALL,			/* bit_4, for DBG_CAT_FPGA */
	DBG_SUBCAT_ALL,			/* bit_5, for DBG_CAT_TEST */
	DBG_SUBCAT_ALL,			/* bit_6, for DBG_CAT_RA */
	DBG_SUBCAT_ALL,			/* bit_7, for DBG_CAT_AP */
	DBG_SUBCAT_ALL,			/* bit_8, for DBG_CAT_CLIENT */
	DBG_SUBCAT_ALL,			/* bit_9, for DBG_CAT_TX */
	DBG_SUBCAT_ALL,			/* bit_10, for DBG_CAT_RX */
	DBG_SUBCAT_ALL,			/* bit_11, for DBG_CAT_CFG */
	DBG_SUBCAT_ALL,			/* bit_12, for DBG_CAT_MLME */
	DBG_SUBCAT_ALL,			/* bit_13, for DBG_CAT_PROTO */
	DBG_SUBCAT_ALL,			/* bit_14, for DBG_CAT_SEC */
	DBG_SUBCAT_ALL,			/* bit_15, for DBG_CAT_PS */
	DBG_SUBCAT_ALL, 		/* bit_16, for DBG_CAT_POWER */
	DBG_SUBCAT_ALL,			/* bit_17, for DBG_CAT_COEX */
	DBG_SUBCAT_ALL,			/* bit_18, for DBG_CAT_P2P */
	DBG_SUBCAT_ALL,			/* bit_19 */
	DBG_SUBCAT_ALL,			/* bit_20 */
	DBG_SUBCAT_ALL,			/* bit_21 */
	DBG_SUBCAT_ALL,			/* bit_22 */
	DBG_SUBCAT_ALL,			/* bit_23 */
	DBG_SUBCAT_ALL,			/* bit_24 */
	DBG_SUBCAT_ALL,			/* bit_25 */
	DBG_SUBCAT_ALL,			/* bit_26 */
	DBG_SUBCAT_ALL,			/* bit_27 */
	DBG_SUBCAT_ALL,			/* bit_28 */
	DBG_SUBCAT_ALL,			/* bit_29 */
	DBG_SUBCAT_ALL,			/* bit_30, for DBG_CAT_RSV1 */
	DBG_SUBCAT_ALL			/* bir_31, for DBG_CAT_RSV2 */
};
...
{
	printk("Show General Allocated Memory Info:\n");
	ShowMIList(&MemInfoList);
	printk("Maximum Allocated Memory Size: %u\n", MemInfoList.MaxAlcSize);
	printk("Current Allocated Memory Size: %u\n", MemInfoList.CurAlcSize);
	return MemInfoList.EntryNumber;
}

UINT32 ShowPktAllocInfo(VOID)
{
	printk("Show Packet Allocated Memory Info:\n");
